...
import { Box, Flex, ScrollArea, Heading, Button, Card, Tooltip, IconButton, Container, Text } from "@radix-ui/themes"
...
export function IndexContent({ videos }: { videos: readonly IVideo[] }) {
